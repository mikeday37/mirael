...
A program for visually exploring planar graph embeddings.
...
- [MSVC compiler](https://learn.microsoft.com/en-us/cpp/build/reference/compiling-a-c-cpp-program?view=msvc-170)
